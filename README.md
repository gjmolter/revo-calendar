...
| lang                       | string    | `'en'`                                            | Calendar's language                                                                                                                                          | `en`, `pt`, `es`, `de` or any other if custom `languages` is used                         |
...
| allowAddEvent              | bool      | `true`                                            | If `true`, will display add event button on right panel                                                                                                      | `true` or `false`                                                                         |
